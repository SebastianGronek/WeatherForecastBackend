...
public class WeatherBitMapper {
    public List<Forecast> convertToWeather(WeatherBitDTO weatherBitDTO) {
        ...
        for (WeatherBitDTO.Data currentData : data) {
            ...
            result.add(new Forecast(provider, timeOfObservation, description, cityName, pressure, /*seaLevelPressure,*/ windSpeed, windDirection, temperature, apparentTemperature, clouds, humidity, precipitation, snow));
        }
        return result;
    }
}
